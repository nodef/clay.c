...
Clay_RenderCommandArray ClayVideoDemo_CreateLayout(ClayVideoDemo_Data *data) {
  ...
  CLAY(CLAY_ID("OuterContainer"),
    ...
    CLAY(CLAY_ID("HeaderBar"),
      ...
      CLAY(CLAY_ID("FileButton"), {.layout = {.padding = {16, 16, 8, 8}},
                                   .backgroundColor = {140, 140, 140, 255},
                                   .cornerRadius = CLAY_CORNER_RADIUS(5)}) {
        ...
        if (fileMenuVisible) { // Below has been changed slightly to fix the
                               // small bug where the menu would dismiss when
                               // mousing over the top gap
    ...
    CLAY(CLAY_ID("LowerContent"),
      ...
      CLAY(CLAY_ID("MainContent"),
        ...
        Document selectedDocument =
            documents.documents[data->selectedDocumentIndex];
